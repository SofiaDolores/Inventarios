...
if (isset($_REQUEST['guardar'])) { 
    ...
    $sql_query = "INSERT INTO directorio(folio, nombre, telefono, costos, notas) VALUES ('$fusion', '$nombre', '$telefono', '$costos', '$notas')";
  ...
  <div class="row">
    ...
    <div class="letra scroll">
       <center><h1>Registro Telefonico</h1></center> 
        ...
        <form class="row g-3" action="directorio.php" method="POST" autocomplete="off">
            <div class="col-md-4">
